...
class TRGenerator:
    ...
    def _gen_functional(self, model: DemandModel) -> List[TestRequirement]:
        ...
        # This generation call has shown a reproducible complete-failure
        # mode (returns 0 usable TRs despite non-empty, well-formed
        # input) across multiple documents in practice; retry once
        # before giving up, since isolated re-invocation of this same
        # call has been observed to succeed reliably (see R4a diagnosis).
